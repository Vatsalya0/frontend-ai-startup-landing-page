            ...
            {testimonials.map((testimonial) => (
              ...
              >
                ...
                <div className="flex items-center gap-3 mt-5">
                  <div className="relative after-content[''] after:absolute after:inset-0 after:bg-[rgb(140,69,244)] after:mix-blend-soft-light before:content-[''] before:absolute before:z-10 before:rounded-lg before:border before:border-white/30 before:inset-0">
                    <Image
